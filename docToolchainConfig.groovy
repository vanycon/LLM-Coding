...
microsite.with {
    ...
    title = 'Bibliothek der Dinge – Leihgut'
    ...
    // (already set above; kept here only for reference)
    //title = 'docToolchain'
    //
    ...
    // run the 'copyLandingPage' task to get an editable copy you can customize
    landingPage = 'landingpage.gsp'

    // --- brand customization (fonts, colors, logo) ---------------------------
    // Re-brand the microsite without copying the whole theme. Every value is
    // optional: leave it empty/unset to keep the theme default.
    //
    // logo: path to your logo, relative to the site's asset root.
    //logo = 'images/my-logo.png'
    //
    // colors: any CSS color value (hex, rgb(), hsl(), ...).
    ...
    //
    // fonts: a CSS font-family value, e.g. "'Roboto', sans-serif".
    //fontHeading = "'Roboto', sans-serif"
    //fontBody    = "'Open Sans', sans-serif"
    //fontMono    = "'JetBrains Mono', monospace"
    // optional stylesheet to load custom web fonts (e.g. a Google Fonts URL)
